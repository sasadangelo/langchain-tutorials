...
class GranitePromptFormatter(PromptFormatter):
    PROMPT_TEMPLATE = (
        "If available, use the following pieces of context enclosed by triple backquote to answer the question at the "
        "end\n"
    ...
    def get_prompt(self, system_message, chat_history_messages, user_message):
        ...
        ).format(context=chat_history, user_message=user_message.content)
